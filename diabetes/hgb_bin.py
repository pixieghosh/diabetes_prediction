...
gcv = GridSearchCV(clf_hgb, param_grid= params, n_jobs = 4, cv = 5, return_train_score = True, scoring = ['f1_weighted','precision_weighted','recall_weighted','roc_auc'], refit = 'f1_weighted').fit(X_train,y_train)
# f1 score
# %%
...
# %%
results = None
with open('hgb_baseline_results_bin.pkl','rb') as results:
